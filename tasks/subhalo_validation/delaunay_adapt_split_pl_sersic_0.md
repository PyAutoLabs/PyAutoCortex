# Subhalo_validation — delaunay_adapt_split on pl_sersic_0 — the false-positive null

Project: subhalo_validation
Summary: Does delaunay_adapt_split false-detect a subhalo on the null lens
State: accepted
Gates:

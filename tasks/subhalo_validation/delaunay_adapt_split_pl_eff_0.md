# Subhalo_validation — delaunay_adapt_split on pl_eff_0 — the clumpy-source lens

Project: subhalo_validation
Summary: Does delaunay_adapt_split false-detect a subhalo on the clumpy source
State: submitted
Gates:
...
Budget: 48:00
Runs: 342027, 342231, 342234, 342299
...
- 342231_1: done — ral — submitted 2026-09-02 — wall 0:02 — job A, source_lp[1] on JAX; rerun with the S/N-3 adapt-image cap and fixed over-sampling (R-20260902-04..07)
- 342234_1: void — ral — submitted 2026-09-02 — wall 0:12 — job B, cancelled 2026-09-02 at 12 min inside source_pix[1] to wait for the numba likelihood speed-ups; partial source_pix[1] output removed on RAL
    after: 342231_1
- 342299_1: submitted — ral — submitted 2026-09-07 — wall 0:00 — job B, numba chain at the standard 1250-pixel Delaunay mesh (8c / 96gb / 48 h); reloads job A 342231_1; the 09-07 ruling: run all datasets at 1250, no more pix1000

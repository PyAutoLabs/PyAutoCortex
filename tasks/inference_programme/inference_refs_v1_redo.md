# Inference_programme — InferenceRefs_v1 redo — the Phase 1 restart wave (array 342091)

Project: inference_programme
Summary: Does the refs array deliver clean reference rows after rewind
State: accepted
Gates:
...
the MGE reuse rule and became `mge_pos_ref_reuse`.

# Inference_programme — slogdet A/B — Cholesky vs slogdet log-det on slam_source_pix_nn (overflow-flood rung 4)

Project: inference_programme
Summary: Does slogdet change the fit versus Cholesky on slam_source_pix_nn
State: dropped
Gates:

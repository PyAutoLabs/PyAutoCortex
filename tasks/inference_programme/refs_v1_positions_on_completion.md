# Inference_programme — InferenceRefs_v1 positions-on completion — pixelization / knn / delaunay_matern (array tasks 11-13)

Project: inference_programme
Summary: Do positions-on replacements give clean references for three mesh cells
State: accepted
Gates:
...
The Phase 1 redo (`inference_refs_v1_redo`, R-20260902-01) certified four positions-on mesh references and

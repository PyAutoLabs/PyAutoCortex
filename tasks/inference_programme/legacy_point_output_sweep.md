# Inference_programme — sweep the point-source families out of the RAL active output/ tree into output/legacy_point/
...
positions-on mesh baselines: **R-20260902-01** (`inference_refs_v1_redo` — `pos_tauto0.2_f1e8`
is the confirmed physical configuration for a mesh source; a mesh run *with*
`positions.info` is citable, one without is not) and **R-20260904-01** (`refs_v1_positions_on_completion`

# Example — the two-band fit, submitted under a gate override

Project: example
Summary: Do the two bands agree on the source centre
State: submitted
...
`output/task_04/joint/samples_summary.json` — source centres within 0.02 arcsec.

## Where to look

- `/mnt/c/Users/Jammy/Science/example/output/task_04/`

# Example — the mesh-pix sweep, dropped

Project: example
Summary: Does the mesh-pix sweep beat the Delaunay anchor
State: dropped
...
`output/legacy_wrong/task_10/*/samples_summary.json` log-evidence vs the anchor.

## Where to look

- `/mnt/c/Users/Jammy/Science/example/output/legacy_wrong/task_10/`

## Runs

- 341950_[0-3]: legacy_wrong — gpu — submitted 2026-08-22 — wall 6:00 — ran on the wrong regularisation
    where: /mnt/c/Users/Jammy/Science/example/output/legacy_wrong/task_10

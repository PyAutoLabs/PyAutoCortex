# Example — phase 2: the pixel-scale sweep, gated on two dev fixes
...
`output/phase_02/*/samples_summary.json` — log-evidence within 2.0 of phase 1.

## Where to look

- `/mnt/c/Users/Jammy/Science/example/output/phase_02/`

# Inference_programme — multi-band compile census completion — A100/multi-core + hetero GPU rows

Project: inference_programme
Summary: Do the confirmatory multi-band compile census legs change anything
State: dropped
Gates:

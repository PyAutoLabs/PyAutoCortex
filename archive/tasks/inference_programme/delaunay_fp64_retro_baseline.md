# Inference_programme — the retro-adopted delaunay_fp64 InferenceRefs_v1 baseline

Project: inference_programme
Summary: Does the retro-adopted delaunay_fp64 reference baseline still stand
State: dropped
Gates:
...
The twin of `mge_fp64_retro_baseline`: `results/baselines/InferenceRefs_v1/delaunay_fp64/` was adopted
...
`mge_fp64_retro_baseline`: the baseline's `source_artifact` is

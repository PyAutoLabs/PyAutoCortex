# Inference_programme — cluster-scale gradient-search benchmark (Prodigy vs Nautilus, point-source)

Project: inference_programme
Summary: Does Prodigy beat Nautilus at cluster scale for point sources
State: dropped
Gates:

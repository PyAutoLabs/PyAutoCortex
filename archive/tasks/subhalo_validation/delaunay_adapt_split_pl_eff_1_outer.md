# Subhalo_validation — delaunay_adapt_split on pl_eff_1_outer — the outer-component lens, plus the AdaptSplit fix rerun

Project: subhalo_validation
Summary: Does delaunay_adapt_split false-detect on the outer-component lens and AdaptSplit fix
State: submitted
Gates:
